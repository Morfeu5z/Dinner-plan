     ...
     * Przesyłamy listę parametrów jako array list [['1', 'a'],['2', 'b']]
     * Funkcja zwraca parametry z serwera jako json i konwertuje do array list [['1', 'a'],['2', 'b']]
     * Można ustalic metodę
     * Można ustalić ścieżkę
     * @param dict : array with string elements - parametry do przesłania [['1', 'a'],['2', 'b']]
     ...
     */
    function simpleAjax(list = ['string'], path = 'SAT', method = 'POST') {
        dict = {'param': list};
